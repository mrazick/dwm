...
static const char *fonts[] = { "IBMPlexMonoNerdFontCompleteBigGlyphs:size=10:antialias=true:autohint=true" };
static const char dmenufont[] = "IBM Plex Mono Semibold:size=10";
...
const char *spcmd2[] = {"st",     "-n", "spvifm", "-g",
                        "144x41", "-e", "vifmrun",   NULL};
...
/* tagging */
static const char *tags[] = {"₁", "₂", "輸₃", "4₄", "5₅", "6₆", "7₇", "8₈", "₉"};
...
static Key keys[] = {
    ...
    {ALTSHIFT, XK_u, setlayout, {.v = &layouts[5]}},
    {ALTSHIFT, XK_o, setlayout, {.v = &layouts[6]}},
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MEHMOD, XK_q, quit, {0}},
    {HYPEMOD, XK_q, quit, {1}},
};
